...
{
public:
    BOOST_STATIC_ASSERT(detail::is_variant_exchange<object_t>::value);
    BOOST_STATIC_ASSERT(detail::is_variant_exchange<array_t>::value);
    BOOST_STATIC_ASSERT(detail::is_variant_exchange<null_t>::value);
